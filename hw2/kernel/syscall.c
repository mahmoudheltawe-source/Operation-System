...
extern uint64 sys_race_reset(void);
extern uint64 sys_race_inc(void);
extern uint64 sys_race_get(void);
...
[SYS_race_reset] sys_race_reset,
[SYS_race_inc] sys_race_inc,
[SYS_race_get] sys_race_get,
